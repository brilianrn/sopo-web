...
export const metadata: Metadata = {
  ...
  title: 'SOPO | Bersama Membangun Ekosistem Agribisnis Berkelanjutan untuk Lahan',
  description:
  ...
  openGraph: {
    title: 'SOPO | Ekosistem Pertanian Digital Berbasis Sacha Inchi untuk Lahan',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'SOPO - Ekosistem Pertanian Digital Berbasis Sacha Inchi untuk Lahan',
      },
    ],
    locale: 'id_ID',
    type: 'website',
  ...
  keywords: [
    'SOPO',
    'Ekosistem Agribisnis Berkelanjutan untuk Lahan',
    'Pertanian Digital',
    'Sacha Inchi',
